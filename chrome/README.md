...
Your settings are saved automatically and synced across devices (if signed into Chrome).
...
- **activeTab** - Access the current tab's URL only when you click the extension
- **contextMenus** - Add "View Page Source" to the right-click menu
- **storage** - Save your preferences (syntax highlighting, word wrap)
